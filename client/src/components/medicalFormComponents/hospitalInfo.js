            ...
            <Card.Body>
              ...
              <Form>
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    type="text"
                    placeholder="A.I. duPont Hospital for Children"
                    name="hospital"
                    defaultValue={this.props.values.hospital}
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    defaultValue={this.props.values.hospitalAddress}
                    onChange={this.props.handleChange}
                    required
                  />
                </Form.Group>
                ...
                <Row className="mb-3">
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      ...
                      name="hospitalCity"
                      defaultValue={this.props.values.hospitalCity}
                      onChange={this.props.handleChange}
                      required
                    />
                  </Form.Group>
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Select
                      defaultValue={this.props.values.hospitalState}
                      onChange={this.props.handleChange}
                      name="hospitalState"
                      required
                    >
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      name="hospitalZip"
                      defaultValue={this.props.values.hospitalZip}
                      onChange={this.props.handleChange}
                      placeholder="44101"
                      required
                    />
