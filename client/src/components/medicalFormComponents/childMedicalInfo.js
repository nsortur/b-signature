              ...
              <Form>
                <Row>
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      ...
                      name="childPhysician"
                      defaultValue={this.props.values.childPhysician}
                      onChange={this.props.handleChange}
                      required
                    />
                  </Form.Group>
                ...
                <Row>
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      type="text"
                      placeholder="e.g. Leukemia, Lymphoma, other"
                      name="childDiagnosis"
                      defaultValue={this.props.values.childDiagnosis}
                      onChange={this.props.handleChange}
                      required
                    />
                  </Form.Group>
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      type="date"
                      name="diagnosisDate"
                      defaultValue={this.props.values.diagnosisDate}
                      onChange={this.props.handleChange}
                      required
                    ></Form.Control>
                  </Form.Group>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    type="text"
                    name="notableFacts"
                    defaultValue={this.props.values.notableFacts}
                    onChange={this.props.handleChange}
                    required
                  />
                  <Form.Text>
                    Please describe the child's medical condition, anticipated
                    hospital stay, and any other notable facts.
                  </Form.Text>
                </Form.Group>
