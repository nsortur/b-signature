...
DsJwtAuth.prototype.checkToken = function _checkToken(
  ...
  if (this._debug) {
    if (noToken) {
      ...
      console.log(
        this._debug_prefix + ": " + "checkToken: Starting up--need a token"
      );
    }
    if (needToken && !noToken) {
      ...
      console.log(
        this._debug_prefix + ": " + "checkToken: Replacing old token"
      );
    }
    if (!needToken) {
      if (!this._debug) {
      ...
      console.log(
        this._debug_prefix + ": " + "checkToken: Using current token"
      );
    }
  }
