 ...
 */
function makePrefilledTextTab(anchorString, xOffset, xWidth, value) {
 ...
 * @returns a DocuSign tab
 */
function makeTextTab(anchorString, xOffset, xWidth) {
  return docusign.Text.constructFromObject({
    anchorString: anchorString,
    anchorUnits: "inches",
    anchorCaseSensitive: false,
 ...
 * @returns a DocuSign tab
 */
function makeYTextTab(anchorString, xOffset, yOffset, xWidth) {
  return docusign.Text.constructFromObject({
    anchorString: anchorString,
    anchorUnits: "inches",
    anchorCaseSensitive: false,
...
documentInformation.makeEnvelopeDetails = (docs, req, res) => {
  ...
  let displayName = "B+ Financial Assistance Agreement";
    ...
    switch (doc) {
      ...
      case documents.SOCIAL_WORKER:
        ...
        dsTabs.socWorkTabs.textTabs = [
          ...
          makeTextTab("Email Address (please print)", 1.8, 170),
        ];
